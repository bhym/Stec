...
\begin{document}
  \section*{Model explanation ({\color{red} Methods, maybe SupMat?})}
    ...
    During this phase of variable length, the population stops growing and experience a prolonged burst of extra mortality.
...
%
  \section*{Results}
    ...
    A slower growth rate of $P$ ($r_p=1.82$, \textbf{plot {\color{blue}\textit{c}}} vs $r_p=1$, \textbf{plot {\color{blue}\textit{d}}}) that leaves more nitrogen available favours the growth of $F_{1}$, thus producing a greater abundance of $F_{1}$ and a lower abundance of $P$.
  ...
  \section*{Discussion}
    ...
    Furtmermore, the concentration increase during bloom has a strong positive feedback on mating --- itself scaling with parental cell abundance, related to $\alpha$ in the model --- because it boost encounter rate.~\cite{d2010time} inferred form data and modeling that the life cycle of \textit{P. multistriata} consists of two phases characterised by opposite growth rate trends (slow vs fast).
