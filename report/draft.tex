    ...
    \subsection*{Tabular data}
        \begin{table}[h]
          \begin{subtable}[h]{0.45\textwidth}
            \centering
            \input{tbls/ranr0p-ranalp_1.tex}
            \caption{Duration of the growth block: 1 day}
          \end{subtable}
          %
          \begin{subtable}[h]{0.45\textwidth}
            \centering
            \input{tbls/ranr0p-ranalp_2.tex}
          ...
          \begin{subtable}[h]{0.45\textwidth}
            \centering
            \input{tbls/ranr0p-ranalp_3.tex}
            \caption{Duration of the growth block: 3 days}
          \end{subtable}
          %
          \begin{subtable}[h]{0.45\textwidth}
            \centering
            \input{tbls/ranr0p-ranalp_4.tex}
          ...
          \begin{subtable}[h]{0.45\textwidth}
            \centering
            \input{tbls/ranr0p-ranalp_5.tex}
            \caption{Duration of the growth block: 5 days}
          \end{subtable}
          %
          \begin{subtable}[h]{0.45\textwidth}
            \centering
            \input{tbls/ranr0p-ranalp_6.tex}
